...
export default function MapView({ location, pois, playingPoi, language, favorites, onToggleFavorite, isOffline }: MapViewProps) {
  const defaultCenter = { lat: 21.0285, lng: 105.8542 }; // Hanoi default
