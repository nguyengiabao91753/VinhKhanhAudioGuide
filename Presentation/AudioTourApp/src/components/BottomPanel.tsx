      ...
      <div className="p-6">
        ...
        <div className="flex gap-3">
          <button
            ...
            className={`flex-1 py-4 rounded-2xl font-bold text-lg flex items-center justify-center gap-2 transition-all active:scale-95 ${isTracking
          ...
          {hasLocation && (
            <button
              ...
              className={`px-6 rounded-2xl font-bold flex items-center justify-center transition-all active:scale-95 ${isSimulating
